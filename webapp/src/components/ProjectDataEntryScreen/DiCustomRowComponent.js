...
function DiCustomRowComponent(props) {
    ...
    const changeModalValue = (e) =>{
      ...
      const index = props.customJustification.findIndex(object=>{
        console.log(props.details.customKpiId)
        console.log(object.customKpiId)
      ...
      return (
        ...
        centered >
          ...
          <Label>Enter  KPI Justification</Label>
              <Input type="text" id="inputID" name={modalname} readOnly value={justificationInput[modalname]}></Input>
          </Modal.Body>
          <Modal.Footer>
...
export default DiCustomRowComponent