...
// const index = props.kpiList.findIndex(object=>{
//   return object.kpiId === props.details.kpiId

// })
//   if(index !== -1){
//     props.kpiList[index].month = input
//     console.log("inputttttt",props.kpiList)
//   }
}
...
<Modal show={show} onHide={handleClose}  size="lg"
    ...
    centered >
      ...
      <Label>Enter  KPI Justification</Label>
          <Input type="text" id="inputID" name={modalname} value={justificationInput[modalname]} onChange={(e)=>changeModalValue(e)} style={{height:"auto",overflow:"auto",maxWidth:"100%"}}></Input>
      </Modal.Body>
      <Modal.Footer>
