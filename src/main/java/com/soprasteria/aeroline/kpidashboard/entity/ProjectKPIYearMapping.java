...
@Entity
public class ProjectKPIYearMapping {
    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int projectKPIYearId;
    private int kpiId;
    ...
    public int getProjectKPIYearId() {
        return projectKPIYearId;
    }
    public void setProjectKPIYearId(int projectKPIYearId) {
        this.projectKPIYearId = projectKPIYearId;
    }
    public int getKpiId() {
        return kpiId;
    }
    ...
    public ProjectKPIYearMapping() {
    }
    public ProjectKPIYearMapping(int projectKPIYearId, int kpiId, int projectId, int kpiThreshold, int year,
            int january, int february, int march, int april, int may, int june, int july, int august, int september,
            int october, int november, int december, String januaryJustification, String februaryJustification,
            String marchJustification, String aprilJustification, String mayJustification, String juneJustification,
            String julyJustification, String augustJustification, String septemberJustification,
            String octoberJustification, String novemberJustification, String decemberJustification) {
        this.projectKPIYearId = projectKPIYearId;
        this.kpiId = kpiId;
        this.projectId = projectId;
        this.kpiThreshold = kpiThreshold;
