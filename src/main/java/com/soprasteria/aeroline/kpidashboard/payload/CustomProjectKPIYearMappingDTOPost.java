...
public class CustomProjectKPIYearMappingDTOPost {
    ...
    public CustomProjectKPIYearMappingDTOPost() {
    }
    public CustomProjectKPIYearMappingDTOPost(String customKpiName, int customKpiThreshold, int january, int february,
