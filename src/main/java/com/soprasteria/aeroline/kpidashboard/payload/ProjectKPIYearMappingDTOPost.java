...
public class ProjectKPIYearMappingDTOPost {
    ...
    public ProjectKPIYearMappingDTOPost() {
    }
    public ProjectKPIYearMappingDTOPost(String kpiName, int kpiThreshold, int january, int february, int march,
            int april, int may, int june, int july, int august, int september, int october, int november,
            int december) {
        this.kpiName = kpiName;
        this.kpiThreshold = kpiThreshold;
        this.january = january;
